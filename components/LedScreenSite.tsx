...
const FAQ_GROUPS = [
  ...
  { label: "Pantallas", items: [
    { question: "¿Qué tamaños de pantallas LED tienen?", answer: "Contamos con pantallas desde 6 m² hasta más de 60 m².", bullets: ["Medidas comunes: 3×2, 4×2,5, 4×3, 5×3, 6×3, 6×4 m y más según necesidad."] },
...
const EN: Record<string, string> = {
  "Inicio": "Home", "Servicios": "Services", "Eventos": "Events", "Trabajos": "Work", "Cotizador": "Quote builder",
  ...
  "Configurá tu evento en 3D": "Configure your event in 3D", "Ver trabajos": "View our work", "Visualizá el montaje a escala y envialo por WhatsApp.": "Preview the setup to scale and send it through WhatsApp.",
  ...
  "Abrir configurador": "Open configurator", "Cerrar configurador": "Close configurator", "CONFIGURADOR 3D": "3D CONFIGURATOR", "Armá tu escenario": "Build your setup", "Elegí pantallas, sonido e iluminación y visualizá cómo podría verse tu montaje a escala.": "Choose screens, sound and lighting, and preview your setup to scale.",
  ...
  "Contamos con pantallas desde 6 m² hasta más de 60 m².": "We offer screens from 6 m² to more than 60 m².", "Medidas comunes: 3×2, 4×2,5, 4×3, 5×3, 6×3, 6×4 m y más según necesidad.": "Common sizes: 3×2, 4×2.5, 4×3, 5×3, 6×3, 6×4 m, and larger options as needed.",
